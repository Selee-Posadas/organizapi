...
export class SubjectController {
    ...
    @Get(':id/correlatives')
    async getCorrelatives(@Param('id', ParseUUIDPipe) id: string, @GetUser('id') userId: string) {
    ...
    async addCorrelative(
        ...
        return await this.addCorrelativeUseCase.execute(subjectId, requiredId, type, userId);
    }
    ...
    async removeCorrelative(
        ...
        return await this.removeCorrelativeUseCase.execute(subjectId, requiredId, userId);
    }
}