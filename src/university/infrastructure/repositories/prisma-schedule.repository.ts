...
export class PrismaScheduleRepository implements ScheduleRepository {
  ...
  async findAllSchedulesWithDetails(
    userId: string,
  ): Promise<ScheduleWithDetailsDto[]> {
  ...
  async findScheduleByEnrollment(
    enrollmentId: string,
    userId: string,
  ): Promise<Schedule[]> {
    const schedules = await this.prisma.schedule.findMany({
  ...
  async findSchedulesByDayOfWeek(
    dayOfWeek: DayOfWeek,
    userId: string,
  ): Promise<Schedule[]> {
    const schedules = await this.prisma.schedule.findMany({
  ...
  async findSchedulesByStartTime(
    startTime: string,
    userId: string,
  ): Promise<Schedule[]> {
    const schedules = await this.prisma.schedule.findMany({
  ...
  async findSchedulesByDayWithDetails(
    day: DayOfWeek,
    userId: string,
  ): Promise<ScheduleWithDetailsDto[]> {
    const schedules = await this.prisma.schedule.findMany({
