...
export interface ResourceRepository {
  ...
  updateResource(id: string, userId: string, data: Partial<Resource>): Promise<Resource>;
  deleteResource(id: string, userId: string): Promise<void>;
  
  findResourceById(id: string, userId: string): Promise<Resource | null>;
  findResourcesByEnrollment(enrollmentId: string, userId: string): Promise<Resource[]>;
  ...
  toggleReadStatus(id: string, userId: string, isRead: boolean): Promise<Resource>;

  findResourcesWithDetails(enrollmentId: string, userId: string): Promise<ResourceWithDetailsDto[]>;
}